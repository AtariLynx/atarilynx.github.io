...
## Connecting USB devices to a devcontainer
...
- **Restart udev service**  
  You can restart the service for devices by running the following command:
  
  ```sudo service udev restart```

  Afterwards reattach the device to your WSL distros by running
