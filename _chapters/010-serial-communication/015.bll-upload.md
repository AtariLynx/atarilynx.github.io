...
BLL has uploader support as part of the debugging capabilities. You can include the uploader using `new_bll` with the following actions:
...
Your BLL code for lyxass will look similar to this:
