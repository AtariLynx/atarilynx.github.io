...
![alt text](../../assets/chapters/obfuscated-blocks-inside-frame.png){ width=50% }
...
![alt text](../../assets/chapters/encrypted-blocks-inside-frame.png)

## Complete example: micro bootloader

The micro bootloader has a minimalistic 48 byte first stage that fits well within the size of a single block. The source code of the loader is listed in the chapter on boot loaders. The compiled byte array serves as example data to perform a full encryption process.
