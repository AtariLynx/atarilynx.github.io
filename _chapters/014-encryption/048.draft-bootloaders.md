...
|`HSIZOFFH`|`$7F`|Almost any value $0000-$00ff will do|
...
The first files holds 32 bytes to populate the color palette, followed by the SCB data.

> ### Fun fact
>
> The game "Todd's Adventures in Slimeworld" has a slightly different first stage. A tiny portion of the code has a different order in copying the palette and setting the display location correctly. All other cartridges do the two operations in reversed order.
>
>```6502
