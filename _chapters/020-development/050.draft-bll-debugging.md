...
All that is required is setting the `BRKuser` value at the top of your main file and initialize the break server by using the `INITBRK` macro.
...
It is possible to shortcut the 
